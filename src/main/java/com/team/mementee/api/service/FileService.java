...
public class FileService {
    ...
    public MessageType getFileType(String contentType) {
        ...
        if ("application/pdf".equals(contentType)) return MessageType.PDF;
        if ("application/zip".equals(contentType)) return MessageType.ZIP;
        if ("text/vcard".equals(contentType)) return MessageType.CONTACT;
        else return MessageType.FILE;
    }
